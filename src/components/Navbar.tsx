  ...
  return (
    <nav className="w-full h-12 border-b border-b-gray-300">
      <div className="mx-auto h-full container flex flex-row">
        <div
            className="flex space-x-3 select-none justify-center text-sm font-semibold items-center border-b-transparent h-full w-fit px-4 border-b-2">
          <div className="flex space-x-1 justify-center px-1.5 py-1 bg-gray-100 z-10 rounded-xl items-center">
